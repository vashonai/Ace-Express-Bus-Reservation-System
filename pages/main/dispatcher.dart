...
class _DispatcherState extends State<Dispatcher> {
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            height: 50,
                            child: ElevatedButton(
                              onPressed: viewEmployeeLocationDispatcher,
                              child: const Text('View Employee Location'),
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            height: 50,
                            child: ElevatedButton(
                              onPressed: viewDriverLocationDispatcher,
  ...
  void viewEmployeeLocationDispatcher() {
    Navigator.pushNamed(context, '/view_employee_location_dispatcher');
  }

  void viewDriverLocationDispatcher() {
    Navigator.pushNamed(context, '/view_driver_location_dispatcher');
  }
